...
<tr class="form-field">
	...
	<td>
		<div id="product_brand_thumbnail" style="float:left;margin-right:10px;"><img alt="<?php _e( 'Product brand thumbnail', 'yith-woocommerce-brands-add-on-premium' ) ?>" src="<?php echo $image; ?>" width="60px" height="60px" /></div>
